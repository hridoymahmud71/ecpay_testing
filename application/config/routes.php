...
$route['test/atm'] 			= 'test/atm';
$route['test/all'] 			= 'test/all';
$route['test/barcode'] 		= 'test/barcode';
$route['test/cvs'] 			= 'test/cvs';
$route['test/credit'] 		= 'test/credit';
$route['test/googlepay'] 	= 'test/googlepay';
$route['test/web_atm'] 		= 'test/web_atm';
